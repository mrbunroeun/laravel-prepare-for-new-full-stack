                    ...
                    <div id="bedroom3-carousel-track"
                        ...
                        @foreach ($discoverImages as $index => $image)
                            <button type="button"
                                ...
                                class="bedroom3-carousel-item relative overflow-hidden rounded-none shadow-md
                                ...
                                <img src="{{ $image }}" alt="Wealth Mansion 3-Bedroom view {{ $index + 1 }}"
        ...
        <script>
            (function() {
                function initBedroom3Carousel() {
                    const wrapper = document.getElementById("bedroom3-carousel-height-wrapper");
