    ...
    <div class="relative w-full pt-[112px] min-[1161px]:pt-[120px]">
        ...
        <div class="relative w-full h-[420px] sm:h-[460px] md:h-[500px] lg:h-[540px] xl:h-[580px] max-h-[600px] overflow-hidden">
            <img class="w-full h-full object-cover object-center"
                src="{{ asset('services/propertis_leasing/bedroom.png') }}" 
                alt="1 Bedroom - Wealth Mansion">
                    ...
                    <div id="bedroom1-carousel-track"
                        ...
                        @foreach ($discoverImages as $index => $image)
                            <button type="button"
                                ...
                                class="bedroom1-carousel-item relative overflow-hidden rounded-none shadow-md
                                ...
                                <img src="{{ $image }}" alt="Wealth Mansion 1 Bedroom view {{ $index + 1 }}"
        ...
        <script>
            (function() {
                function initBedroom1Carousel() {
                    const wrapper = document.getElementById("bedroom1-carousel-height-wrapper");
