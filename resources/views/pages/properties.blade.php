...
@section('content')
    ...
    <section class="relative w-full bg-[#2A5A8A] z-[300] mt-0 pt-8 sm:pt-12 pb-16 sm:pb-20">
        {{-- Background Image Offset Down --}}
        <div class="absolute inset-x-0 bottom-0 top-[130px] sm:top-[160px] lg:top-[180px] z-0 overflow-hidden">
        ...
        <div class="relative z-10 w-full pl-6 sm:pl-10 lg:pl-16 xl:pl-24 pr-0">
            <div class="flex flex-col lg:flex-row items-stretch justify-between gap-4 lg:gap-6">
                ...
                <div class="relative z-20 shrink-0 max-w-[320px] self-start pt-16 sm:pt-24 lg:pt-52">
                ...
                <div id="featured-properties-grid" class="flex-1 w-full max-w-[1240px] grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-2 sm:gap-2.5 items-stretch pr-0">
                    @foreach ($featuredProjects as $project)
                        <div class="featured-prop-card bg-white flex flex-col justify-between shadow-2xl overflow-hidden transition-transform duration-300 hover:-translate-y-1"
