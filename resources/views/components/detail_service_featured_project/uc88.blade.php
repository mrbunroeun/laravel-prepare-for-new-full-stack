...
@section('content')
    @php
        $heroData = \App\Models\HeroSection::where('page', 'properties-uc88')->first();
        $heroTaglineHtml = $heroData?->tagline_html ?: ($heroData?->tagline_box1 ?: 'UC88');
        $heroHeadline = $heroData?->headline ?: "Residential Property\nProject";
