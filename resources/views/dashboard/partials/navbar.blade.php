<header class="h-20 bg-white border-b border-slate-200 px-4 sm:px-6 lg:px-8 flex items-center justify-between z-30 sticky top-0 shadow-xs">
    ...
    <div class="flex items-center gap-3 sm:gap-4">
        ...
        <div class="relative">
            <button onclick="toggleNotificationDropdown()" id="navbar-notif-btn" class="relative p-2 rounded-lg text-slate-500 hover:text-[#163049] hover:bg-slate-100 transition-colors cursor-pointer">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path>
                </svg>
                <span id="navbar-notif-badge" class="hidden absolute top-1 right-1 px-1.5 py-0.2 text-[10px] font-bold rounded-full bg-[#1479B9] text-white">0</span>
            </button>
