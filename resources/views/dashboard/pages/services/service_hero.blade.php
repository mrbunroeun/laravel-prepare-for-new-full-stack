            ...
            <div>
                <div class="flex flex-wrap items-center justify-between gap-2 mb-1.5">
                    ...
                    <div class="flex flex-wrap items-center gap-1.5">
                        <button type="button" onclick="insertSvcFaqBold()" class="px-2 py-0.5 bg-slate-100 hover:bg-[#2A5A8A] hover:text-white text-slate-700 rounded text-[11px] font-semibold transition-colors flex items-center gap-1 cursor-pointer" title="Bold selection"><strong>B</strong></button>
                        <div class="relative" id="svc-link-dropdown-wrapper">
                            <button type="button" onclick="toggleSvcLinkDropdown()" class="px-2 py-0.5 bg-[#2A5A8A]/10 hover:bg-[#2A5A8A] hover:text-white text-[#2A5A8A] rounded text-[11px] font-semibold transition-colors flex items-center gap-1 cursor-pointer border border-[#2A5A8A]/30">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"></path></svg>
                                <span>Insert Internal Link</span>
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                            </button>
                            <div id="svc-link-dropdown" class="hidden absolute right-0 top-full mt-1 z-50 w-72 bg-white border border-slate-200 rounded-xl shadow-xl py-1 text-[12px]">
                                <div class="px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-400 border-b border-slate-100">Services</div>
                                <button type="button" onclick="insertSvcInternalLink('Property Management', '/services/property-management')" class="w-full text-left px-4 py-2 hover:bg-[#2A5A8A]/5 text-slate-700 hover:text-[#2A5A8A] transition-colors cursor-pointer flex items-center gap-2">
                                    <span class="w-1.5 h-1.5 rounded-full bg-[#2A5A8A] shrink-0"></span>Property Management
                                </button>
                                <button type="button" onclick="insertSvcInternalLink('Property Sales', '/services/property-sales')" class="w-full text-left px-4 py-2 hover:bg-[#2A5A8A]/5 text-slate-700 hover:text-[#2A5A8A] transition-colors cursor-pointer flex items-center gap-2">
                                    <span class="w-1.5 h-1.5 rounded-full bg-[#2A5A8A] shrink-0"></span>Property Sales
                                </button>
                                <button type="button" onclick="insertSvcInternalLink('Property Leasing', '/services/property-leasing')" class="w-full text-left px-4 py-2 hover:bg-[#2A5A8A]/5 text-slate-700 hover:text-[#2A5A8A] transition-colors cursor-pointer flex items-center gap-2">
                                    <span class="w-1.5 h-1.5 rounded-full bg-[#2A5A8A] shrink-0"></span>Property Leasing
                                </button>
                                <button type="button" onclick="insertSvcInternalLink('Hospitality Services', '/services/hospitality-services')" class="w-full text-left px-4 py-2 hover:bg-[#2A5A8A]/5 text-slate-700 hover:text-[#2A5A8A] transition-colors cursor-pointer flex items-center gap-2">
                                    <span class="w-1.5 h-1.5 rounded-full bg-[#2A5A8A] shrink-0"></span>Hospitality Services
                                </button>
                                <div class="px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-400 border-b border-t border-slate-100">Main Pages</div>
                                <button type="button" onclick="insertSvcInternalLink('Browse Properties', '/properties')" class="w-full text-left px-4 py-2 hover:bg-[#2A5A8A]/5 text-slate-700 hover:text-[#2A5A8A] transition-colors cursor-pointer flex items-center gap-2">
                                    <span class="w-1.5 h-1.5 rounded-full bg-slate-400 shrink-0"></span>Browse Properties
                                </button>
                                <button type="button" onclick="insertSvcInternalLink('About Us', '/about-us')" class="w-full text-left px-4 py-2 hover:bg-[#2A5A8A]/5 text-slate-700 hover:text-[#2A5A8A] transition-colors cursor-pointer flex items-center gap-2">
                                    <span class="w-1.5 h-1.5 rounded-full bg-slate-400 shrink-0"></span>About Us
                                </button>
                                <button type="button" onclick="insertSvcInternalLink('Contact Us', '/contact-us')" class="w-full text-left px-4 py-2 hover:bg-[#2A5A8A]/5 text-slate-700 hover:text-[#2A5A8A] transition-colors cursor-pointer flex items-center gap-2">
                                    <span class="w-1.5 h-1.5 rounded-full bg-slate-400 shrink-0"></span>Contact Us
                                </button>
                                <button type="button" onclick="insertSvcInternalLink('Events', '/events')" class="w-full text-left px-4 py-2 hover:bg-[#2A5A8A]/5 text-slate-700 hover:text-[#2A5A8A] transition-colors cursor-pointer flex items-center gap-2">
                                    <span class="w-1.5 h-1.5 rounded-full bg-slate-400 shrink-0"></span>Events
                                </button>
                                <button type="button" onclick="insertSvcInternalLink('Insights', '/insights')" class="w-full text-left px-4 py-2 hover:bg-[#2A5A8A]/5 text-slate-700 hover:text-[#2A5A8A] transition-colors cursor-pointer flex items-center gap-2">
                                    <span class="w-1.5 h-1.5 rounded-full bg-slate-400 shrink-0"></span>Insights
                                </button>
                                <button type="button" onclick="insertSvcInternalLink('Partners', '/partners')" class="w-full text-left px-4 py-2 hover:bg-[#2A5A8A]/5 text-slate-700 hover:text-[#2A5A8A] transition-colors cursor-pointer flex items-center gap-2">
                                    <span class="w-1.5 h-1.5 rounded-full bg-slate-400 shrink-0"></span>Partners
                                </button>
                            </div>
                        </div>
                    </div>
                </div>
                <textarea id="faq-answer" required rows="5" placeholder="Enter detailed answer... &#10;&#10;Tip: Use • bullet points or the 'Insert Internal Link' button above to link to other pages." class="w-full px-4 py-2.5 bg-[#f8fafc] border border-slate-300 rounded-lg text-sm text-slate-900 focus:outline-none focus:border-[#2A5A8A] leading-relaxed font-sans"></textarea>
                <p class="text-[11px] text-slate-400 mt-1">Tip: Lines starting with <code class="bg-slate-100 px-1 rounded font-mono text-slate-600">•</code> become bullet lists. Internal links are inserted as <code class="bg-slate-100 px-1 rounded font-mono text-slate-600">[Label](/url)</code> syntax and rendered as clickable links.</p>
            </div>
...
<script>
    ...
    // ── FAQ FORMATTING HELPERS ──────────────────────────────────────────
    function insertSvcFaqBullet() {
        const ta = document.getElementById('faq-answer');
    ...
    function toggleSvcLinkDropdown() {
        const dd = document.getElementById('svc-link-dropdown');
        dd.classList.toggle('hidden');
    }

    function insertSvcInternalLink(label, url) {
        const ta = document.getElementById('faq-answer');
        const start = ta.selectionStart;
        const end   = ta.selectionEnd;
        const val   = ta.value;
        const selected = val.substring(start, end);
        const linkLabel = selected || label;
        const insertion = `[${linkLabel}](${url})`;
        ta.value = val.substring(0, start) + insertion + val.substring(end);
        ta.setSelectionRange(start + insertion.length, start + insertion.length);
        ta.focus();
        document.getElementById('svc-link-dropdown').classList.add('hidden');
    }

    // Close dropdown when clicking outside
    document.addEventListener('click', function(e) {
        const wrapper = document.getElementById('svc-link-dropdown-wrapper');
